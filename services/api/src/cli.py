...
__parser.add_argument("--model", type=str, required=True, help="The model to use for the Ollama service")
__parser.add_argument("--ollama", type=str, required=True, help="The Ollama service URL")
